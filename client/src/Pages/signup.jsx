...
import { Stethoscope, User, Mail, Lock, ArrowRight, UserCheck, UserCog } from 'lucide-react'
          ...
          <div className="relative z-10 h-full flex flex-col justify-between p-12">
            ...
            <div>
              ...
              <p className="mt-3 text-rose-100/80 text-sm max-w-sm leading-relaxed">
                Manage appointments, track medicines, and streamline your clinic &mdash; all in one place.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="mt-6 flex gap-2 bg-gray-100 rounded-xl p-1">
              <button
                ...
                className={`flex-1 flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg text-sm font-medium transition-all cursor-pointer ${
                  role === 'patient'
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 pr-4 py-2.5 border rounded-lg text-sm outline-none transition-colors ${
                      errors.name ? 'border-red-400 focus:border-red-500' : 'border-gray-300 focus:border-rose-400'
                    }`}
                  />
                </div>
